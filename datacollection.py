...
#    print("Key received!")
    if event.type == pygame.KEYUP :
        ...
        if char == 'w' :
            ...
            imageName = '/home/pi/Desktop/Project/Data/w/' + str(imgSize_w)+'.jpg'
            imgSize_w = imgSize_w + 1
        ...
        if char == 'a' :
            ...
            imageName = '/home/pi/Desktop/Project/Data/a/' + str(imgSize_a)+'.jpg'
            imgSize_a = imgSize_a + 1
            camera.capture(imageName)
            for i in range(0,50):
        ...
        if char == 'd' :
            ...
            imageName = '/home/pi/Desktop/Project/Data/d/' + str(imgSize_d)+'.jpg'
            imgSize_d = imgSize_d + 1
            camera.capture(imageName)
            for i in range(0,35):
        ...
        if char == 'q' :
            ...
            output_name = "true.csv"
            with open(output_name, mode = 'w') as csvfile :
